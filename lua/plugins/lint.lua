return {
    ...
    config = function()
        ...
        require("lint").linters.npm_run_lint = {
            cmd = "npm",
            args = { "run", "lint:ci", "--silent", "--", "--format", "json" }, -- list of arguments. Can contain functions with zero arguments that will be evaluated once the linter is used.
        ...
        }, { create_group = "Linting", nested = true })
    end,
}
